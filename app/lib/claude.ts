...
STEP 9. 사람의 어깨 끝에서 손목까지의 팔 길이를 픽셀로 측정하고 cm로 변환하세요. 이는 착용한 옷의 소매와 무관하게 신체의 팔 길이를 측정하는 것입니다. 민소매나 나체인 경우 팔이 더 잘 보이므로 더 정확하게 측정할 수 있습니다. 30cm 미만으로 측정되면 오류이므로 키/몸무게 비율로 재보정하세요.
